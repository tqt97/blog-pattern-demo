                                        ...
                                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                            ...
                                            <div class="lg:col-span-2 space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <x-textarea id="excerpt" name="excerpt" rows="3"
                                                        class="mt-1"
                                                ...
                                                <div>
                                                    ...
                                                    <x-textarea id="content" name="content" rows="11"
                                                        class="mt-1"
                                            ...
                                            <div class="space-y-4">
                                                {{-- Thumbnail lên đầu --}}
                                                <div>
                                                    <x-uploader.single label="Thumbnail" fieldName="thumbnail"
                                                        :initial="$post->thumbnail ?? null" :initial-url="$post->thumbnail_url ?? null"
                                                ...
                                                <div>
                                                    ...
                                                    <select id="category_id" name="category_id"
                                                        ...
                                                        @foreach ($categories as $id => $name)
                                                            <option value="{{ $id }}"
                                                                @selected(old('category_id', $post?->category_id) == $id)>
                                                                {{ $name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                @php
                                                    $oldTags = collect(
                                                        old(
                                                            'tag_ids',
                                                            isset($post) ? $post->tags->pluck('id')->toArray() : [],
                                                        ),
                                                    );
                                                @endphp
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    <x-text-input id="published_at" class="block mt-1 w-full"
                                                        type="datetime-local" name="published_at" :value="old(
                                                            'published_at',
                                    ...
                                    <div x-show="tab === 'seo'" x-cloak>
                                        <div class="space-y-3">
                                            ...
                                            <div>
                                                ...
                                                <x-textarea id="meta_description" name="meta_description"
                                                    rows="4"
