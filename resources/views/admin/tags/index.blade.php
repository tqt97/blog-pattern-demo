<x-app-layout>
    <x-slot name="header">
        <x-pages.header title="Tags List" action="{{ route('admin.tags.create') }}" buttonText="Create"
            icon="plus" />
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <main class="max-w-7xl mx-auto pb-2">
                        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            {{-- Filters --}}
                            <x-filters :action="route('admin.tags.index')" :baseExcept="['page']">
                                ...
                                <div
                                    ...
                                    <x-table>
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                                <x-table.empty colspan="3" message="No tags found"
                                                    icon="tag" />
                                            @endforelse
                                        </tbody>
                                    </x-table>
